...
if(SYSTEM_ENVIRONMENT == 'test'){
    ...
    //site credentials
    define('CR_SITE_NAME', "Lily Berry Events"); 
    define('CR_SITE_NAME_PIPE', CR_SITE_NAME." | "); 



    //site db
    define('DB_DATABASE', "loc_lily_berry_events"); 
    ...
    //site db
    define('DB_DATABASE', "db_lilyberryevents"); 
    define('DB_HOST_NAME', "dedi698.jnb1.host-h.net"); 
    define('DB_USERNAME', "lilybbujeq_1"); 
    define('DB_PASSWORD', "qv7aCbKkrXy4T8t"); 
    define('DB_PORT', "3306"); 

    //email
    define('EMAIL_PROTOCOL', "smtp"); 
    define('EMAIL_HOST', "mail.lilyberryevents.com"); 
    define('EMAIL_PORT', "587"); 
    define('EMAIL_USERNAME', "info@lilyberryevents.com"); 
    define('EMAIL_PASSWORD', "MSEDvtEcj2gDXD79M"); 
    define('EMAIL_ADDRESS', "info@lilyberryevents.com"); 
}